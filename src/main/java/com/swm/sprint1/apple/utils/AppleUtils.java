package com.swm.sprint1.apple.utils;
...
import com.swm.sprint1.apple.model.Key;
import com.swm.sprint1.apple.model.Keys;
...
public class AppleUtils {
    ...
    public Payload decodeFromIdToken(String id_token) {
        ...
        try {
            ...
            ObjectMapper objectMapper = new ObjectMapper();
            Payload payload = objectMapper.readValue(getPayload.toString(), Payload.class);
